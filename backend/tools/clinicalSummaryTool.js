...
Hospital course was uncomplicated. Serial troponins were ${timelineData.labResults?.[0]?.result || "Normal"} and ECG showed ${timelineData.labResults?.[1]?.result || "Normal"}.
Patient was managed medically with ${timelineData.medicationsGiven?.join(", ") || "None reported"}.
